...
urlpatterns = [
    ...
    path('pending-invitations/',get_pending_invitations, name='pending-invitations' ),
    path('sent-invitation/', SendInvitationView.as_view(), name='sent-invitation'),
    path('manage-invitation/<int:invitation_id>/', ManageInvitationView.as_view(), name='manage-invitation'),
